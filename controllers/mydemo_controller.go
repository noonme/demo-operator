...
//+kubebuilder:rbac:groups=apps.opsblogs.cn,resources=mydemoes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=apps.opsblogs.cn,resources=mydemoes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=apps.opsblogs.cn,resources=mydemoes/finalizers,verbs=update
